...
def main(argv=sys.argv):
    parser = argparse.ArgumentParser(description='Receive a single 140-mer base sequence, and return the donor site probability.')
    if len(argv) != 2:
        parser.parse_args(['-h'])
    ...
    print ('Donor site probability: {}'.format(predict[0][0]))
